    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        potentialOffender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SingleTextViewFragment.showSingleTextLayout(getActivity(), getString(R.string.bystander_intervention), getString(R.string.bystander_potential_offender), getString(R.string.bystander_verbal_offender));
            }
        });
        ...
        potentialVictim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SingleTextViewFragment.showSingleTextLayout(getActivity(), getString(R.string.bystander_intervention), getString(R.string.bystander_potential_victim), getString(R.string.bystander_verbal_victim));
            }
        });
        ...
        tacticsForBoth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SingleTextViewFragment.showSingleTextLayout(getActivity(), getString(R.string.bystander_intervention), getString(R.string.bystander_tactics_both), getString(R.string.bystander_non_verbal));
            }
        });
